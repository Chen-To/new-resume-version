...
\section{\textcolor{Blue}{Technical Skills}}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{\textcolor{NavyBlue}{Languages}}{: Java, TypeScript, JavaScript, Python, C++, C, SQL, Bash, HTML, CSS} \\
     \textbf{\textcolor{NavyBlue}{Technologies}}{: Spring Boot, Kafka, Flink, React, Node.js, Express.js, REST APIs, NoSQL, Flask, LangChain, sklearn} \\
...
\section{\textcolor{Blue}{Experience}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {{\href{https://www.ibm.com/ca-en}{\textcolor{NavyBlue}{IBM}}} $|$ \textnormal{Java, Python, React, Spring Boot, Kafka, Flink, MongoDB, Kubernetes}}{May 2024 -- Aug 2024}
